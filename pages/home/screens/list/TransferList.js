  ...
  return(
    <View style={styles.List}>
      <View  style={styles.left}>
        ...
        <Text style={styles.data}>Patient Full Name: {props.object.patient_full_name}</Text>
        <Text style={styles.data}>Patient Age: {props.object.patient_age}</Text>
        <Text style={styles.data}>Patient Medical Condition: {props.object.patient_medical_condition}</Text>
...
export default TransferList = ({navigation}) => {
  ...
  useEffect(() => {
    const q = query(collection(firebase, "Bookings"), where("booking_type", "==", "Transfer"), where("status", "==", "pending"));
