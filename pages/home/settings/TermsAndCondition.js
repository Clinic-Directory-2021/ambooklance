    ...
    return(
        <ScrollView>
            <View style={styles.container}>
                ...
                <Text></Text>
                <View>
                    <Text style={styles.title}>Modifications to Our service</Text>
                    <Text></Text>
                    <Text style={styles.text}>
                ...
                <Text></Text>
                <View>
                    <Text style={styles.title}>Updates to Our service</Text>
                    <Text></Text>
                    <Text style={styles.text}>
                        We may from time to time provide enhancements or improvements to the features/ functionality of the service, which may include patches, bug fixes, updates, upgrades and other modifications ("Updates"). Updates may modify or delete certain features and/or functionalities of the service. You agree that we have no obligation to (i) provide any Updates, or (i) continue to provide or enable any particular features and/or functionalities of the service to you. You further agree that all Updates will be (i) deemed to constitute an integral part of the service, and (if) subject to the terms and conditions of this Agreement.
                    </Text> 
                </View>
                <Text></Text>
                <View>
                ...
                <View>
                    ...
                    <Text></Text>
                    <Text style={styles.text}>
                        This section applies to any dispute EXCEPT IT DOESN'T INCLUDE A DISPUTE RELATING TO CLAIMS FOR INJUNCTIVE OR EQUITABLE RELIEF REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Ambooklance's INTELLECTUAL PROPERTY RIGHTS. The term "dispute" means any dispute, action, or other controversy between you and us concerning the Services or this agreement, whether in contract, warranty, tort, statute, regulation, ordinance, or any other legal or equitable basis. "Dispute" will be given the broadest possible meaning allowable under law.
                    </Text> 
                </View>
                <Text></Text>
                <View>
                ...
                <Text></Text>
                <View>
                    <Text style={styles.title}>Definitions and key terms</Text>
                    <Text></Text>
                    <Text style={styles.text}>
                    ...
                    <Unorderedlist>
                        ...
                        <Unorderedlist>
                            <Text style={styles.text}>
                            	Company: when this policy mentions "Company." "we." "us." or "our," it refers to Ambooklance that is responsible for your information under this Privacy Policy.
                            </Text>
                        </Unorderedlist>
                        <Unorderedlist>
                            <Text style={styles.text}>
                                Country: where Ambooklance or the owners/founders of Ambooklance are based, in this case is Philippines.
                            </Text>
                        </Unorderedlist>
                        <Unorderedlist>
                            <Text style={styles.text}>
                            	Customer: refers to the company, organization or person that signs up to use the Ambooklance Service to manage the relationships with your consumers or service users.
                            </Text>
                        </Unorderedlist>
                        <Unorderedlist>
                            <Text style={styles.text}>
                            	Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Ambooklance and use the services.
                            </Text>
                        </Unorderedlist>
                        <Unorderedlist>
                            <Text style={styles.text}>
                        ...
                        <Unorderedlist>
                            <Text style={styles.text}>
                            	Personnel: refers to those individuals who are employed by Ambooklance or are under contract to perform a service on behalf of one of the parties.
                            </Text>
                        </Unorderedlist>
                        <Unorderedlist>
                            <Text style={styles.text}>
                        ...
                        <Unorderedlist>
                            <Text style={styles.text}>
                            	Service: refers to the service provided by Ambooklance as described in the relative terms (if available) and on this platform.
                            </Text>
                        </Unorderedlist>
                        <Unorderedlist>
                            <Text style={styles.text}>
                        ...
                        <Unorderedlist>
                            <Text style={styles.text}>
                                Website: Ambooklance's site, which can be accessed via this URL:
                            </Text>
                        </Unorderedlist>
                        <Unorderedlist>
                            <Text style={styles.text}>
                            	You: a person or entity that is registered with Ambooklance to use the Services
                            </Text>
                        </Unorderedlist>
                </View>
                <Text></Text>
                ...
                <View>
                    ...
                    <Text></Text>
                    <Text style={styles.text}>
                        Ambooklance grants you a revocable, non-exclusive, non- transferable, limited license to download, install and use our service strictly in accordance with the terms of this Agreement. These Terms & Conditions are a contract between you and Ambooklance (referred to in these Terms & Conditions as "Ambooklance". "us", "We" or "our"), the provider of the Ambooklance website and the services accessible from the Ambooklance website (which are collectively referred to in these Terms & Conditions as the "Ambooklance Service"'). You are agreeing to be bound by these Terms & Conditions. If you do not agree to these Terms & Conditions, please do not use the Service. In these Terms & Conditions, "you" refers both to you as an individual and to the entity you represent. If you violate any of these Terms & Conditions, we reserve the right to cancel your account or block access to your account without notice.
                    </Text>
                </View>
                <Text></Text>
                <View>
